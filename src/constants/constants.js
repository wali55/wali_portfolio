export const projects = [
    ...
    {
      title: 'Website for Review',
      description: "This is single page application built using react router. It is called Best Laptop Deals. User can go to different routes without reloading the page.",
      image: '/images/4.png',
      tags: ['React', 'React router', 'Tailwind CSS'],
      source: 'https://github.com/wali55/assignment-nine',
      visit: 'https://assignment-nine-wali.netlify.app/',
      id: 3,
    },
  ];
